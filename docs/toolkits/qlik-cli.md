---
title: "Qlik-cli overview | Qlik Developer Portal"
source_url: "https://qlik.dev/toolkits/qlik-cli/"
local_path: "docs/toolkits/qlik-cli.md"
---

Title: Qlik-cli overview | Qlik Developer Portal


[Skip to content](https://qlik.dev/toolkits/qlik-cli/#start-of-content)[![Image 2: Qlik logo](https://qlik.dev/logo.svg)](https://qlik.dev/)
...
[View as Markdown](https://qlik.dev/toolkits/qlik-cli.md)
...
![Image 3: qlik-cli example commands](https://qlik.dev/_astro/qlik-cli.zJ9forEO.gif)

The tool comes with built-in documentation, which is accessed by appending the `--help` flag to any command.

## [](https://qlik.dev/toolkits/qlik-cli/#get-started) Get started

### [Get started with qlik-cli Learn how to install qlik-cli for Windows, Mac or Linux](https://qlik.dev/toolkits/qlik-cli/install-qlik-cli/)### [Authenticate to Qlik using qlik-cli contexts Learn how to create contexts to connect to resources](https://qlik.dev/toolkits/qlik-cli/qlik-cli-contexts/)### [How pagination works in qlik-cli Learn how to use pagination to save resources and enhance user experience](https://qlik.dev/toolkits/qlik-cli/qlik-cli-pagination/)### [Get started with qlik-cli examples Learn how to use qlik-cli for common use cases](https://qlik.dev/toolkits/qlik-cli/get-started-qlik-cli/)### [Handle character escaping in qlik-cli Learn how to properly escape special characters in --body and --filter options across shells and operating systems](https://qlik.dev/toolkits/qlik-cli/qlik-cli-escaping/)
...
*   [Get started](https://qlik.dev/toolkits/qlik-cli/#get-started)

Was this page helpful?
*   yes 
*   no 

![Image 4: Qlik logo](https://qlik.dev/logo-footer.svg)
...
![Image 5: Company Logo](https://cdn.cookielaw.org/logos/0fff665c-78ed-4cdf-8357-4cb648f38616/018f1b3a-c29f-79e8-84cb-8f0f597a1714/bdc0e6d8-2ecf-48dc-808d-33588709b9b4/qliklogo_2024.png)
