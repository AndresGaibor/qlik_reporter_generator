---
title: "qlik-api code examples | Qlik Developer Portal"
source_url: "https://qlik.dev/toolkits/qlik-api/examples/"
local_path: "docs/toolkits/qlik-api-examples.md"
---

Title: qlik-api code examples | Qlik Developer Portal


[Skip to content](https://qlik.dev/toolkits/qlik-api/examples/#start-of-content)[![Image 1: Qlik logo](https://qlik.dev/logo.svg)](https://qlik.dev/)
...
[View as Markdown](https://qlik.dev/toolkits/qlik-api/examples.md)
...
qlik-api is a package that provides a JavaScript API for interacting with Qlik Sense REST APIs and the Qlik Associative Engine. It can be used in both Node.js and browser contexts.
...
New to qlik-api? Start with [Create app](https://qlik.dev/toolkits/qlik-api/examples/#creating-and-opening-analytics-applications) to understand the basics of initializing and creating an analytics app.

## [](https://qlik.dev/toolkits/qlik-api/examples/#creating-and-opening-analytics-applications) Creating and opening analytics applications

### [Create app Create an analytics app. javascript](https://qlik.dev/toolkits/qlik-api/examples/create-app/)### [Create a session app Use non-persistent apps for working with temporary data sets. javascript](https://qlik.dev/toolkits/qlik-api/examples/create-session-app/)### [Open app without data Access the metadata of an app without opening it with data. javascript](https://qlik.dev/toolkits/qlik-api/examples/open-app-no-data/)

## [](https://qlik.dev/toolkits/qlik-api/examples/#analytics-application-metadata) Analytics application metadata

### [List sheets in an app Get a list of sheets. javascript](https://qlik.dev/toolkits/qlik-api/examples/app-sheet-list/)

## [](https://qlik.dev/toolkits/qlik-api/examples/#working-with-analytics-data) Working with analytics data

### [createCube for qlik-api Update your use of createCube from Capability API to qlik-api. javascript html](https://qlik.dev/toolkits/qlik-api/examples/create-cube/)### [Get current selections Get the current selection object with ease using qlik-api. javascript html](https://qlik.dev/toolkits/qlik-api/examples/get-current-selections/)

## [](https://qlik.dev/toolkits/qlik-api/examples/#platform-operations) Platform operations

### [List spaces Fetch a list of spaces. javascript](https://qlik.dev/toolkits/qlik-api/examples/fetch-spaces/)
...
*   [Creating and opening analytics applications](https://qlik.dev/toolkits/qlik-api/examples/#creating-and-opening-analytics-applications)
*   [Analytics application metadata](https://qlik.dev/toolkits/qlik-api/examples/#analytics-application-metadata)
*   [Working with analytics data](https://qlik.dev/toolkits/qlik-api/examples/#working-with-analytics-data)
*   [Platform operations](https://qlik.dev/toolkits/qlik-api/examples/#platform-operations)
