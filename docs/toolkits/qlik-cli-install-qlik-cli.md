---
title: "Get started | Qlik Developer Portal"
source_url: "https://qlik.dev/toolkits/qlik-cli/install-qlik-cli/"
local_path: "docs/toolkits/qlik-cli-install-qlik-cli.md"
---

Title: Get started | Qlik Developer Portal


[Skip to content](https://qlik.dev/toolkits/qlik-cli/install-qlik-cli/#start-of-content)[![Image 1: Qlik logo](https://qlik.dev/logo.svg)](https://qlik.dev/)
...
[View as Markdown](https://qlik.dev/toolkits/qlik-cli/install-qlik-cli.md)
...
## [](https://qlik.dev/toolkits/qlik-cli/install-qlik-cli/#install-qlik-cli) Install qlik-cli
...
### [](https://qlik.dev/toolkits/qlik-cli/install-qlik-cli/#install-with-a-package-manager) Install with a package manager

 Windows (Chocolatey)  Linux or macOS (Homebrew) 
...
`Error retrieving packages from source 'https://www.nuget.org/api/v2':The combination of parameters provided to this OData endpoint is no longer supported.Please refer to the following URL for more information about this deprecation: https://aka.ms/nuget/odata-deprecation`
...
`choco uninstall qlik-clichoco install qlik-cli`

To install qlik-cli with [homebrew](https://brew.sh/), you need to first tap our [qlik-oss/taps](https://github.com/qlik-oss/homebrew-taps) if you haven’t already:
...
This will work for Mac or Linux (where you can use `linuxbrew`) and Windows Subsystem Linux (WSL).

### [](https://qlik.dev/toolkits/qlik-cli/install-qlik-cli/#install-manually) Install manually
...
## [](https://qlik.dev/toolkits/qlik-cli/install-qlik-cli/#enable-completion-feature) Enable completion feature

To make it easier to write commands, consider enabling [completion](https://qlik.dev/toolkits/qlik-cli/completion/completion/) which generates auto completion scripts for bash or zsh.

## [](https://qlik.dev/toolkits/qlik-cli/install-qlik-cli/#third-party-dependencies) Third-party dependencies
...
*   [Install qlik-cli](https://qlik.dev/toolkits/qlik-cli/install-qlik-cli/#install-qlik-cli)
*   [Install with a package manager](https://qlik.dev/toolkits/qlik-cli/install-qlik-cli/#install-with-a-package-manager)
*   [Install manually](https://qlik.dev/toolkits/qlik-cli/install-qlik-cli/#install-manually)
*   [Enable completion feature](https://qlik.dev/toolkits/qlik-cli/install-qlik-cli/#enable-completion-feature)
*   [Third-party dependencies](https://qlik.dev/toolkits/qlik-cli/install-qlik-cli/#third-party-dependencies)
