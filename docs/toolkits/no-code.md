---
title: "No-code overview | Qlik Developer Portal"
source_url: "https://qlik.dev/toolkits/no-code/"
local_path: "docs/toolkits/no-code.md"
---

Title: No-code overview | Qlik Developer Portal


[Skip to content](https://qlik.dev/toolkits/no-code/#start-of-content)[![Image 7: Qlik logo](https://qlik.dev/logo.svg)](https://qlik.dev/)
...
[View as Markdown](https://qlik.dev/toolkits/no-code.md)
...
Qlik provides multiple connectors via [Qlik Automate](https://www.qlik.com/us/products/qlik-automate) to support no-code integration and orchestration using APIs on the Qlik Cloud platform, as well as the [Qlik MCP server](https://help.qlik.com/en-US/cloud-services/Subsystems/Hub/Content/Sense_Hub/QlikMCP/Qlik-MCP-server.htm) for interactive AI use cases.

## [](https://qlik.dev/toolkits/no-code/#qlik-mcp---assistant-and-agentic-ai-workflows) Qlik MCP - Assistant and agentic AI workflows

If you are building assistant, agentic, or generative AI experiences with your own tools, you can also use the Qlik MCP server to access Qlik capabilities through Model Context Protocol. For setup and usage details, see [Qlik MCP server](https://help.qlik.com/en-US/cloud-services/Subsystems/Hub/Content/Sense_Hub/QlikMCP/Qlik-MCP-server.htm).

## [](https://qlik.dev/toolkits/no-code/#qlik-automate---qlik-cloud-connectors) Qlik Automate - Qlik Cloud Connectors

In addition to the Qlik Cloud connectors described on this page, Qlik Automate also connects to many third-party services. For more information, see the [Automation connectors page](https://help.qlik.com/en-US/cloud-services/Subsystems/Hub/Content/Sense_QlikAutomation/connector-blocks/connectors-list.htm) on Qlik Help.

|  |  |  |
| --- | --- | --- |
| ![Image 8: Qlik Cloud connector logo](https://qlik.dev/_astro/icon-qlik-cloud.CRb0qXRn_Z1p1n9J.webp) | Qlik Cloud | Integrate events, data, data assets, sets, stores, and objects from your tenant into your automation processes. |
| ![Image 9: Qlik Platform Operations connector logo](https://qlik.dev/_astro/icon-qlik-platform-operations.DFmdUcO2_Z1JWYjQ.webp) | Qlik Platform Operations | Orchestrate one or multiple Qlik Cloud tenants using OAuth clients at either the tenant or region level. |
| ![Image 10: Qlik Reporting connector logo](https://qlik.dev/_astro/icon-qlik-reporting.COnGi_3R_29yGGc.webp) | Qlik Reporting | Build customized, multi-page reports based on app sheets. |
| ![Image 11: Qlik Catalog connector logo](https://qlik.dev/_astro/icon-qlik-catalog.rKL63-8g_PnVsF.webp) | Qlik Catalog | Use the metadata stored in Qlik Catalog (on-premises) in automated workflows. |
| ![Image 12: Qlik Predict connector logo](https://qlik.dev/_astro/icon-qlik-predict.7oIOgjB3_NpNw8.svg) | Qlik Predict | Integrate predictive analytics and machine learning into workflows. |
| ![Image 13: Qlik Talend Data Integration connector logo](https://qlik.dev/_astro/icon-qlik-qcdi.xfv2NAnf_Z17K687.webp) | Qlik Talend Data Integration | Automate Qlik Talend Data Integration projects in your workflows. |

To learn more about how it can help you automate analytics and data workflows without code, see the [Qlik Automate guide](https://help.qlik.com/en-US/cloud-services/Subsystems/Hub/Content/Sense_QlikAutomation/introduction/home-automation.htm) on Qlik Help.

If you’re looking to orchestrate your platform deployments, take a look at the [Platform Operations tutorial series](https://qlik.dev/manage/platform-operations/no-code/overview/) to discover how to get started.
...
*   [Qlik MCP - Assistant and agentic AI workflows](https://qlik.dev/toolkits/no-code/#qlik-mcp---assistant-and-agentic-ai-workflows)
*   [Qlik Automate - Qlik Cloud Connectors](https://qlik.dev/toolkits/no-code/#qlik-automate---qlik-cloud-connectors)

Was this page helpful?
*   yes 
*   no 

![Image 14: Qlik logo](https://qlik.dev/logo-footer.svg)
