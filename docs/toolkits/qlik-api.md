---
title: "Qlik-api overview | Qlik Developer Portal"
source_url: "https://qlik.dev/toolkits/qlik-api/"
local_path: "docs/toolkits/qlik-api.md"
---

Title: Qlik-api overview | Qlik Developer Portal


[Skip to content](https://qlik.dev/toolkits/qlik-api/#start-of-content)[![Image 1: Qlik logo](https://qlik.dev/logo.svg)](https://qlik.dev/)
...
[View as Markdown](https://qlik.dev/toolkits/qlik-api.md)
...
This package provides a JavaScript API for interacting with Qlik Sense REST APIs including the Qlik Associative Engine from a single package that can be used in both Node.js and browser contexts.

## [](https://qlik.dev/toolkits/qlik-api/#get-started) Get Started
...
`<script type="module">  import qlikApi from "https://cdn.jsdelivr.net/npm/@qlik/api/index.mjs";  ...</script>`

## [](https://qlik.dev/toolkits/qlik-api/#module-structure) Module structure
...
`import { subModuleA, subModuleB } from "@qlik/api";import type { SubModuleAType } from "@qlik/api/sub-module-a";import type { SubModuleBType } from "@qlik/api/sub-module-b";`

`@qlik/api` also has a default export with each sub module as properties.

```
import qlikApi from "@qlik/api";
qlikApi.subModuleA;qlikApi.subModuleB;
```
...
## [](https://qlik.dev/toolkits/qlik-api/#rest-api) REST API

`@qlik/api` library is generated from OpenAPI specifications released from those Qlik Cloud services that exposes a restful API. The code generation tool runs using the specs building TypeScript for all API calls specified in the specs. One module per API is generated.

Learn more in the [REST](https://qlik.dev/toolkits/qlik-api/rest/) section.

## [](https://qlik.dev/toolkits/qlik-api/#qix-api) QIX API
...
## [](https://qlik.dev/toolkits/qlik-api/#authentication) Authentication
...
Learn more in the [authentication](https://qlik.dev/toolkits/qlik-api/authentication/) section.

## [](https://qlik.dev/toolkits/qlik-api/#features) Features

`@qlik/api` comes with some handy features to make the development experience as good as possible.

Learn more in the [features](https://qlik.dev/toolkits/qlik-api/features/) section.

## [](https://qlik.dev/toolkits/qlik-api/#examples) Examples
...
*   [Get Started](https://qlik.dev/toolkits/qlik-api/#get-started)
*   [Module structure](https://qlik.dev/toolkits/qlik-api/#module-structure)
*   [REST API](https://qlik.dev/toolkits/qlik-api/#rest-api)
*   [QIX API](https://qlik.dev/toolkits/qlik-api/#qix-api)
*   [Authentication](https://qlik.dev/toolkits/qlik-api/#authentication)
*   [Features](https://qlik.dev/toolkits/qlik-api/#features)
*   [Examples](https://qlik.dev/toolkits/qlik-api/#examples)
