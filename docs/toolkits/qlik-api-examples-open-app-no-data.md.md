...
source_url: "https://qlik.dev/toolkits/qlik-api/examples/open-app-no-data.md/"
local_path: "docs/toolkits/qlik-api-examples-open-app-no-data.md.md"
---
...
[Skip to content](https://qlik.dev/toolkits/qlik-api/examples/open-app-no-data.md/#start-of-content)[![Image 2: Qlik logo](https://qlik.dev/logo.svg)](https://qlik.dev/)
