---
title: "createCube function for qlik-api | Qlik Developer Portal"
source_url: "https://qlik.dev/toolkits/qlik-api/examples/create-cube/"
local_path: "docs/toolkits/qlik-api-examples-create-cube.md"
---

Title: createCube function for qlik-api | Qlik Developer Portal


[Skip to content](https://qlik.dev/toolkits/qlik-api/examples/create-cube/#start-of-content)[![Image 1: Qlik logo](https://qlik.dev/logo.svg)](https://qlik.dev/)
...
[View as Markdown](https://qlik.dev/toolkits/qlik-api/examples/create-cube.md)
...
## [](https://qlik.dev/toolkits/qlik-api/examples/create-cube/#the-createcube-function) The createCube function
...
## [](https://qlik.dev/toolkits/qlik-api/examples/create-cube/#example-hypercube-definition) Example hypercube definition
...
## [](https://qlik.dev/toolkits/qlik-api/examples/create-cube/#using-createcube-with-qlik-api) Using createCube with qlik-api

```
import { auth, qix } from "https://cdn.jsdelivr.net/npm/@qlik/api@2/index.js";import { createCube } from "./createCube.js";
...
## [](https://qlik.dev/toolkits/qlik-api/examples/create-cube/#using-createcube-with-qlik-embed) Using createCube with qlik-embed
...
## [](https://qlik.dev/toolkits/qlik-api/examples/create-cube/#next-steps) Next steps
...
*   [The createCube function](https://qlik.dev/toolkits/qlik-api/examples/create-cube/#the-createcube-function)
*   [Example hypercube definition](https://qlik.dev/toolkits/qlik-api/examples/create-cube/#example-hypercube-definition)
*   [Using createCube with qlik-api](https://qlik.dev/toolkits/qlik-api/examples/create-cube/#using-createcube-with-qlik-api)
*   [Using createCube with qlik-embed](https://qlik.dev/toolkits/qlik-api/examples/create-cube/#using-createcube-with-qlik-embed)
*   [Next steps](https://qlik.dev/toolkits/qlik-api/examples/create-cube/#next-steps)
