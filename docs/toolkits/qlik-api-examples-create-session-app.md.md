...
source_url: "https://qlik.dev/toolkits/qlik-api/examples/create-session-app.md/"
local_path: "docs/toolkits/qlik-api-examples-create-session-app.md.md"
---
...
[Skip to content](https://qlik.dev/toolkits/qlik-api/examples/create-session-app.md/#start-of-content)[![Image 2: Qlik logo](https://qlik.dev/logo.svg)](https://qlik.dev/)
