...
source_url: "https://qlik.dev/toolkits/no-code.md/"
local_path: "docs/toolkits/no-code.md.md"
---
...
[Skip to content](https://qlik.dev/toolkits/no-code.md/#start-of-content)[![Image 2: Qlik logo](https://qlik.dev/logo.svg)](https://qlik.dev/)
