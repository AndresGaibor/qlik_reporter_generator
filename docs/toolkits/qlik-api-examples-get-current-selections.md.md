---
title: "404: Not found | Qlik Developer Portal"
source_url: "https://qlik.dev/toolkits/qlik-api/examples/get-current-selections.md/"
local_path: "docs/toolkits/qlik-api-examples-get-current-selections.md.md"
---
...
[Skip to content](https://qlik.dev/toolkits/qlik-api/examples/get-current-selections.md/#start-of-content)[![Image 2: Qlik logo](https://qlik.dev/logo.svg)](https://qlik.dev/)
...
![Image 3: Error: 404, page cannot be found](https://qlik.dev/_astro/404.GsB2e5X9.png)
# Page not found

## E R R O R 4 0 4

This page cannot be found. Check the URL, and if it is correct, refresh the page. If that does not work, then the page was probably moved or deleted.
