---
title: "Handle character escaping in qlik-cli | Qlik Developer Portal"
source_url: "https://qlik.dev/toolkits/qlik-cli/qlik-cli-escaping/"
local_path: "docs/toolkits/qlik-cli-qlik-cli-escaping.md"
---

Title: Handle character escaping in qlik-cli | Qlik Developer Portal


[Skip to content](https://qlik.dev/toolkits/qlik-cli/qlik-cli-escaping/#start-of-content)[![Image 1: Qlik logo](https://qlik.dev/logo.svg)](https://qlik.dev/)
...
[View as Markdown](https://qlik.dev/toolkits/qlik-cli/qlik-cli-escaping.md)
...
## [](https://qlik.dev/toolkits/qlik-cli/qlik-cli-escaping/#prerequisites) Prerequisites

*   qlik-cli installed and configured
*   A context set up for authentication
*   Familiarity with JSON and OData syntax

## [](https://qlik.dev/toolkits/qlik-cli/qlik-cli-escaping/#escape-quotes-in-the---filter-option) Escape quotes in the `--filter` option

The `--filter` option uses OData syntax.

Example expression: `subject eq "user@example.com"`

All examples in the [Filter examples](https://qlik.dev/toolkits/qlik-cli/qlik-cli-escaping/#filter-examples) section produce this expression.
...
### [](https://qlik.dev/toolkits/qlik-cli/qlik-cli-escaping/#filter-examples) Filter examples

 PowerShell 7  PowerShell 5  Bash 
...
`$subject = "user@example.com"qlik user ls --filter ('subject eq "{0}"' -f $subject)`
...
You can also use `ConvertTo-Json` to build the filter argument when quoting becomes difficult:

Terminal window

`$subject = "user@example.com"qlik user ls --filter $("subject eq `"$subject`"" | ConvertTo-Json)`
...
## [](https://qlik.dev/toolkits/qlik-cli/qlik-cli-escaping/#escape-quotes-in-the---body-option) Escape quotes in the `--body` option
...
### [](https://qlik.dev/toolkits/qlik-cli/qlik-cli-escaping/#body-examples) Body examples
...
$json = ConvertTo-Json -InputObject $body -Compress$escapedJson = ConvertTo-Json -InputObject $json -Compress
...
`qlik raw patch v1/users/696el7cb6df8986cde32kia6 \  --body "[{\"op\":\"replace\",\"path\":\"/name\",\"value\":\"Jane Doe\"}]"`

## [](https://qlik.dev/toolkits/qlik-cli/qlik-cli-escaping/#avoid-escaping-issues) Avoid escaping issues
...
## [](https://qlik.dev/toolkits/qlik-cli/qlik-cli-escaping/#verify-your-escaping-with---verbose) Verify your escaping with `--verbose`
...
`PATCH https://<tenant>/api/v1/users/<userId>...PAYLOAD:[  {    "op": "replace",    "path": "/name",    "value": "Jane Doe"  }]...Status: 204 No ContentEmpty response body`
...
*   [Prerequisites](https://qlik.dev/toolkits/qlik-cli/qlik-cli-escaping/#prerequisites)
*   [Escape quotes in the --filter option](https://qlik.dev/toolkits/qlik-cli/qlik-cli-escaping/#escape-quotes-in-the---filter-option)
*   [Filter examples](https://qlik.dev/toolkits/qlik-cli/qlik-cli-escaping/#filter-examples)
*   [Escape quotes in the --body option](https://qlik.dev/toolkits/qlik-cli/qlik-cli-escaping/#escape-quotes-in-the---body-option)
*   [Body examples](https://qlik.dev/toolkits/qlik-cli/qlik-cli-escaping/#body-examples)
*   [Avoid escaping issues](https://qlik.dev/toolkits/qlik-cli/qlik-cli-escaping/#avoid-escaping-issues)
*   [Verify your escaping with --verbose](https://qlik.dev/toolkits/qlik-cli/qlik-cli-escaping/#verify-your-escaping-with---verbose)
