---
title: "Qlik Sense .NET SDK overview | Qlik Developer Portal"
source_url: "https://qlik.dev/toolkits/net-sdk/"
local_path: "docs/toolkits/net-sdk.md"
---

Title: Qlik Sense .NET SDK overview | Qlik Developer Portal


[Skip to content](https://qlik.dev/toolkits/net-sdk/#start-of-content)[![Image 1: Qlik logo](https://qlik.dev/logo.svg)](https://qlik.dev/)
...
[View as Markdown](https://qlik.dev/toolkits/net-sdk.md)

* * *

 Open in Claude  Open in ChatGPT  Open in Perplexity  Open in VS Code Copilot 

# Qlik Sense .NET SDK overview

The [Qlik Sense .NET SDK](https://help.qlik.com/en-US/sense-developer/Subsystems/NetSDKAPIref/Content/Home.htm) is a development toolbox for use with applications such as Microsoft Visual Studio. It allows developers to make calls to the Qlik Sense Engine (Engine API), access REST APIs, and also render visualizations.

It is available on [NuGet](https://www.nuget.org/packages/QlikSense.NetSDK/).
