---
title: "Get started with qlik-cli examples | Qlik Developer Portal"
source_url: "https://qlik.dev/toolkits/qlik-cli/get-started-qlik-cli/"
local_path: "docs/toolkits/qlik-cli-get-started-qlik-cli.md"
---

Title: Get started with qlik-cli examples | Qlik Developer Portal


[Skip to content](https://qlik.dev/toolkits/qlik-cli/get-started-qlik-cli/#start-of-content)[![Image 1: Qlik logo](https://qlik.dev/logo.svg)](https://qlik.dev/)
...
[View as Markdown](https://qlik.dev/toolkits/qlik-cli/get-started-qlik-cli.md)
...
If you’ve already [installed qlik-cli](https://qlik.dev/toolkits/qlik-cli/install-qlik-cli/) and [configured a context](https://qlik.dev/toolkits/qlik-cli/qlik-cli-contexts/), you can try it out with one of the following common use cases.

## [](https://qlik.dev/toolkits/qlik-cli/get-started-qlik-cli/#list-and-switch-between-contexts) List and switch between contexts
...
## [](https://qlik.dev/toolkits/qlik-cli/get-started-qlik-cli/#renaming-and-updating-a-context) Renaming and updating a context
...
## [](https://qlik.dev/toolkits/qlik-cli/get-started-qlik-cli/#import-a-local-app) Import a local app
...
## [](https://qlik.dev/toolkits/qlik-cli/get-started-qlik-cli/#search-for-an-app-by-name) Search for an app by name
...
## [](https://qlik.dev/toolkits/qlik-cli/get-started-qlik-cli/#create-a-managed-space-and-assign-users) Create a managed space and assign users
...
## [](https://qlik.dev/toolkits/qlik-cli/get-started-qlik-cli/#list-failed-reloads) List failed reloads
...
Since this list can be large, you may wish to employ some type of sorting or selection tool. [jq](https://stedolan.github.io/jq/) is one such tool and can be used to filter out all `failed` reloads from the list.
...
## [](https://qlik.dev/toolkits/qlik-cli/get-started-qlik-cli/#analyze-an-app) Analyze an app
...
## [](https://qlik.dev/toolkits/qlik-cli/get-started-qlik-cli/#limit-the-output-to-only-return-the-id) Limit the output to only return the `id`
...
*   [List and switch between contexts](https://qlik.dev/toolkits/qlik-cli/get-started-qlik-cli/#list-and-switch-between-contexts)
*   [Renaming and updating a context](https://qlik.dev/toolkits/qlik-cli/get-started-qlik-cli/#renaming-and-updating-a-context)
*   [Import a local app](https://qlik.dev/toolkits/qlik-cli/get-started-qlik-cli/#import-a-local-app)
*   [Search for an app by name](https://qlik.dev/toolkits/qlik-cli/get-started-qlik-cli/#search-for-an-app-by-name)
*   [Create a managed space and assign users](https://qlik.dev/toolkits/qlik-cli/get-started-qlik-cli/#create-a-managed-space-and-assign-users)
*   [List failed reloads](https://qlik.dev/toolkits/qlik-cli/get-started-qlik-cli/#list-failed-reloads)
*   [Analyze an app](https://qlik.dev/toolkits/qlik-cli/get-started-qlik-cli/#analyze-an-app)
*   [Limit the output to only return the id](https://qlik.dev/toolkits/qlik-cli/get-started-qlik-cli/#limit-the-output-to-only-return-the-id)
