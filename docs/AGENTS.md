...
Documentación de producto, Qlik, arquitectura, investigación y Superpowers. Para navegación del código usa `docs/agents/`.
...
Subdirectorios: `agents/`, `arquitectura/`, `authenticate/`, `desarrollo/`, `endpoints/`, `historico/`, `org-rest/`, `overview/`, `research/`, `setup/`, `superpowers/`, `toolkits/`.
