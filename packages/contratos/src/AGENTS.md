# AGENTS.md — Contratos src

Organiza contratos por dominio. Prefiere exports explícitos y compatibilidad consciente: web y API compilan contra estos tipos.
...
Subdirectorios: `admin/`, `autenticacion/`, `automatizaciones/`, `comun/`, `descargas/`, `flujos/`, `qlik/`, `reportes/`.
