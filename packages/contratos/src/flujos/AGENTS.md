# AGENTS.md — Contratos / flujos

Contratos compartidos del dominio `flujos`. Busca consumidores en `apps/web` y `apps/api` antes de cambiar campos, enums o schemas.
...
- `packages/contratos/src/flujos/index.ts`
