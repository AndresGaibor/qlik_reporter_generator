# AGENTS.md — Contratos / autenticacion

Contratos compartidos del dominio `autenticacion`. Busca consumidores en `apps/web` y `apps/api` antes de cambiar campos, enums o schemas.
...
- `packages/contratos/src/autenticacion/index.ts`
