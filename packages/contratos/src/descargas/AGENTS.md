# AGENTS.md — Contratos / descargas

Contratos compartidos del dominio `descargas`. Busca consumidores en `apps/web` y `apps/api` antes de cambiar campos, enums o schemas.
