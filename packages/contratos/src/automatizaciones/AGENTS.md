# AGENTS.md — Contratos / automatizaciones

Contratos compartidos del dominio `automatizaciones`. Busca consumidores en `apps/web` y `apps/api` antes de cambiar campos, enums o schemas.
...
- `packages/contratos/src/automatizaciones/index.ts`
