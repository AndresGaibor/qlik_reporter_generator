# AGENTS.md — Contratos / reportes

Contratos compartidos del dominio `reportes`. Busca consumidores en `apps/web` y `apps/api` antes de cambiar campos, enums o schemas.
