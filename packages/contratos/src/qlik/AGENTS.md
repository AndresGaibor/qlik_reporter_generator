# AGENTS.md — Contratos / qlik

Contratos compartidos del dominio `qlik`. Busca consumidores en `apps/web` y `apps/api` antes de cambiar campos, enums o schemas.
...
- `packages/contratos/src/qlik/index.ts`
