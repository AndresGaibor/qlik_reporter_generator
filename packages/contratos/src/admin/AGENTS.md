# AGENTS.md — Contratos / admin

Contratos compartidos del dominio `admin`. Busca consumidores en `apps/web` y `apps/api` antes de cambiar campos, enums o schemas.
...
- `packages/contratos/src/admin/index.ts`
